            ...
            <div class="card mg-b-20">
                    ...
                    <form action="/Search_invoices" method="POST" role="search" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-sm-1 col-md-1">
                                <button class="btn btn-block" style="background-color: #1c4b82; color: white">بحث</button>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        @if (isset($details))
                            <table id="example1" class="table key-buttons text-md-nowrap" style=" text-align: center" data-page-length="50">
                                <thead>
                                <tr>
                                ...
                                @foreach ($details as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $invoice->note }}</td>
                                        <td><a class="" href="Print_invoice/{{ $invoice->id }}">طباعة
                                                الفاتورة&nbsp;&nbsp;<i
